<template>
  <div data-testid="banner-carousel-form" class="block-slider-edit sticky top-[52px] h-[80vh] overflow-y-auto">
    ...
    <div v-if="activeSlide !== undefined && slides[activeSlide]" :data-testid="`slide-settings-${activeSlide}`">
      ...
      >
        <template #summary>
          <h2>Direction & Height</h2>
        </template>

        <div class="mb-6">
          <UiFormLabel class="mb-1">Direction</UiFormLabel>
          <div
          ...
          >
            <div
              ...
              :class="{
                'bg-gray-100 text-gray-900 font-semibold': direction === 'horizontal',
              }"
            ...
            >
              <SfIconCheck
                class="mr-1 w-[1.1rem]"
                :class="{ invisible: direction !== 'horizontal' }"
              />
              Horizontal
            </div>
            ...
            <div
              class="flex items-center justify-center w-1/2 px-4 py-2 cursor-pointer text-sm"
              :class="{
                'bg-gray-100 text-gray-900 font-semibold': direction === 'vertical',
              }"
            ...
            >
              <SfIconCheck
                class="mr-1 w-[1.1rem]"
                :class="{ invisible: direction !== 'vertical' }"
              />
              Vertical
            </div>
          </div>
        ...
        <div class="mb-6">
          <UiFormLabel class="mb-1">Height</UiFormLabel>
          <SfSwitch
            v-model="fullHeight"
...
const direction = computed(() => carouselStructure.value.configuration.direction);
const fullHeight = computed(() => carouselStructure.value.configuration.fullHeight);
