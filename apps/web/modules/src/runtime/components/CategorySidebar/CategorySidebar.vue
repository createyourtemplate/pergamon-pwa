<template>
  ...
  >
    <SfDrawer
      ...
      :disable-esc="true"
      class="w-full rounded shadow-none lg:translate-x-0 z-[100] lg:z-0 lg:static lg:!block -translate-x-full shrink-0 bg-white overflow-y-auto lg:relative lg:overflow-y-visible lg:z-30"
