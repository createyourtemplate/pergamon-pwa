<template>
  <SfAccordionItem v-if="facet" v-model="open">
    <template #summary>
      <div class="flex justify-between items-center border-b border-b-black lg:border-none py-1 px-4 lg:px-2 select-none lg:bg-pergamon-light-gray" @mouseleave="open = false">
    ...
    <div v-if="facetGetters.getType(facet) === 'feedback'" class="lg:absolute lg:shadow-md bg-pergamon-light-gray lg:min-w-[250px] pt-3" @mouseover="open = true" @mouseleave="open = false">
    ...
    <form v-else-if="facetGetters.getType(facet) === 'price'" class="lg:absolute lg:shadow-md bg-pergamon-light-gray lg:min-w-[250px] mb-4 px-4" @submit.prevent="updatePriceFilter" @mouseover="open = true" @mouseleave="open = false">
      <div class="mb-3">
        <label for="min">
