<template>
  <SfAccordionItem v-model="internalModelValue" :summary-class="finalSummaryClass" data-testid="accordion-item">
    <template #summary>
      ...
      <SfIconAdd v-if="!internalModelValue" size="sm" class="text-neutral-500" />
      <SfIconRemove v-else size="sm" class="text-neutral-500" />
    </template>
...
import { SfAccordionItem, SfIconAdd, SfIconRemove } from '@storefront-ui/vue';
